            ...
            <View style={styles.main_view}>
                ...
                <View style={styles.v2}>
                    ...
                    <View style={styles.v4}>
                        ...
                        <Text allowFontScaling={false} style={styles.text2}>£{this.props.data.expenditures==null?0:this.props.data.expenditures}</Text>
                    </View>
                ...
                <View style={styles.v2}>
                    ...
                    <View style={styles.v4}>
                        ...
                        <Text allowFontScaling={false} style={styles.text2}>£{this.props.data.profit==null?0:this.props.data.profit}</Text>
                    </View>
