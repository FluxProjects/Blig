...
export default class CompanyProfile extends React.Component {
    ...
    getDetails = async () => {
        ...
        await fetch(this.state.url + '/Company/Mcompany_Detail', {
            ...
            .then(res => res.json())
            .then(resjson => {
                console.log("Company detail==================>", resjson.Message)
                if (resjson.Successful) {
                    ...
                    this.setState({
                        ...
                        obj: temp,
                        Types: resjson.data.entrepreneurcompanies
                    })
...
const styles = StyleSheet.create({
    ...
    v222: { width: 90, height: 90, borderWidth: 1, borderColor: '#cececd', borderRadius: 50, overflow: 'hidden', justifyContent: 'center', alignItems: "center" },
