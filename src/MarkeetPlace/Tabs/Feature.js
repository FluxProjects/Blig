        ...
        await fetch(this.state.url + '/MarketPlace/MCompany_Featured', {
            ...
            .then(resjson => {
                ...
                if (resjson.Successful) {
                    //                    result[index1].entrepreneurcompanies[index].companytype_id
                    let Types = [];
                                            ...
                                            <View style={styles.v3}>
                                                ...
                                                <View style={styles.types}>
                                                    <View style={{ flexDirection: 'row' }}>
                                                        {
                                                            this.state.Types1[index].map((data, i) => (
                                                                i <= 2 ?
                                                                    <Text allowFontScaling={false} style={styles.text2}>{this.state.Companytype[data.companytype_id - 1]}, </Text>
                                                                    :
                                                                    <View>
                                                                    </View>
                                                            ))
...
const styles = StyleSheet.create({
    ...
    v2: { width: '45%', height: '100%', backgroundColor: '#1F1724', borderRadius: 10, flexDirection: "column", alignItems: "center", },
