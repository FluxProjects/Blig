...
export default class SignUp extends Component {
  ...
  send_sms = async () => {
    ...
    /*
    todo commenting below line as it ends the function
*/
    // };
    ...
    await fetch('https://api.txtlocal.com/send/', {
      ...
      .then(resjson => {
        ...
        /*
              todo Added below two brackets '}' and ')' verify with dev team
              */
      })
      .catch(err => {
        alert('Error');
          ...
          <ScrollView>
            <View style={styles.vmargin}>
              <Text
                ...
                style={[styles.ltext, {marginLeft: 10}]}>
                SIGN UP{' '}
              </Text>
              <Item
                style={[
                ...
                floatingLabel>
                <Label allowFontScaling={false} style={styles.username}>
                  Email
                </Label>
                <Input
                  keyboardType="email-address"
                  allowFontScaling={false}
                  onChangeText={value => this.Validation(value, 'email')}
                  onEndEditing={() => {
                    if (
              ...
              <Item
                ...
                <Input
                  allowFontScaling={false}
                  onChangeText={value => this.Validation(value, 'phone')}
                  value={this.state.phone}
                  style={styles.input}
                />
              </Item>
              {/*Todo verify with dev team whether the view can be closed here of not*/}
            </View>
            <View style={[styles.v, {width: '80%', alignSelf: 'center'}]}>
              <Item
                style={[
                  styles.item2,
                  !this.state.passValidate ? styles.error : null,
                ]}
                floatingLabel>
                <Label allowFontScaling={false} style={styles.username}>
                  Password
                ...
                <Input
                  ...
                  onChangeText={pass => this.Validation(pass, 'password')}
                  style={styles.input}
                />
              </Item>
              <Icon
            ...
            <View style={[styles.v, {width: '80%', alignSelf: 'center'}]}>
              <Item
                style={[
                  styles.item2,
                  !this.state.confirmpassValidate ? styles.error : null,
                ]}
                floatingLabel>
                <Label allowFontScaling={false} style={styles.username}>
                  Confirm Password
                ...
                <Input
                  allowFontScaling={false}
                  onChangeText={pass =>
                    this.Validation(pass, 'confrimpassword')
                  }
              ...
              <TouchableWithoutFeedback onPress={() => this.gotoLogIn()}>
                <ImageBackground
                  source={require('../images/buttoncolor.png')}
              ...
              {/*
todo Added text tag it was missing before verify with dev team
*/}
              <Text
                allowFontScaling={false}
                style={styles.alreadyAcount}
                onPress={() => this.gotoLogIn2()}>
