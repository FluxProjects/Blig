        ...
        <ImageBackground resizeMode="stretch" source={require('../images/signup.png')} style={styles.bgimg}>
          <ScrollView >
            <View style={styles.vmargin_c}>
              <Text allowFontScaling={false} style={[styles.ltext_c, { alignSelf:'center' }]}>Category</Text>
              <Textarea  allowFontScaling={false} rowSpan={5}  placeholder="Company or product Description & type" placeholderTextColor="#878787" style={[styles.v33, { color: 'white', height: 180 }]} />



              <View style={[styles.vl,{marginTop:'80%'}]}>
