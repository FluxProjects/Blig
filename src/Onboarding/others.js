        ...
        <ImageBackground resizeMode="stretch" source={require('../images/signup.png')} style={styles.bgimg}>
          <ScrollView >
            <View style={styles.vmargin_c}>
              <Text allowFontScaling={false} style={[styles.ltext_c, { alignSelf:'center' }]}>Others</Text>
             
              <Textarea  allowFontScaling={false} rowSpan={5}  placeholder="Anything that you have discovered(Optional)" placeholderTextColor="#878787" style={[styles.v33, { color: 'white', height: 180 }]} />
              <Textarea  allowFontScaling={false} rowSpan={5}  placeholder="Why blacklion (BLIG)" placeholderTextColor="#878787" style={[styles.v33, { color: 'white', height: 180 }]} />
