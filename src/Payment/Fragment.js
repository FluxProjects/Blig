...
export default class Fragment extends Component {
    ...
    Screen = () => {
        ...
        if (this.state.screennumber == 1) {
            return (<Invest TotalCompanyAmount={this.props.TotalAmount} Amount={this.state.Total_Investment} SendData={(index, data) => this.UpdateData(index, data)} Equity={this.state.Equity} />)
        }
            ...
            return (<ProjectDetail TotalCompanyAmount={this.props.TotalAmount} Amount={this.state.Total_Investment} SendData={(index, data) => this.UpdateData(index, data)} Equity={this.state.Equity} MileStones={this.state.Milestoneno} />)
        }
