            ...
            .then(resjson => {
                ...
                if (resjson.Successful) {
                   this.setState({
                        ...
                        CompanyTypes: resjson.CompanyTypes,
                        investment_req: resjson.Companydata[0].investment_req,
                        investment_eq: resjson.Companydata[0].investment_eq,
                        companyDetail: resjson.Companydata,
                         flag: true,
                        loading: false
                    })
                    ...
                    this.state.Active ? <View>
                        ...
                        <View style={styles.v5}>
                            ...
                            <View style={styles.v4}>
                                <TouchableWithoutFeedback onPress={() => Actions.Payment({TotalAmount:this.state.investment_req,  Company_Id: this.props.Company_Id, Equity: this.state.investment_eq })}>
                                    <ImageBackground resizeMode="stretch" source={require('../../images/buttoncolor.png')} style={styles.btnimage}>
                                        <Text onPress={() => Actions.Payment({TotalAmount:this.state.investment_req, Company_Id: this.props.Company_Id, Equity: this.state.investment_eq })} style={styles.text3}>Make an Investment</Text>
                                    </ImageBackground>
                                </TouchableWithoutFeedback>
                            </View>
                        </View>
