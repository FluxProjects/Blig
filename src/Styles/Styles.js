...
export default StyleSheet.create({
   ...
   //Oboarding ..............
   //company
   vmargin_c: { marginTop: '5%' },
   ltext_c: { color: 'white', fontSize: 30, },



   ///signup
   btnimage2: { width: 254, height: 56, marginTop: 20, alignItems: 'center', justifyContent: 'center', alignSelf: 'center' },
   itemstyle: { width: '80%', borderBottomWidth: 1, borderBottomColor: '#EC9705', marginTop: 1, alignSelf: 'center' },
   ...
   text: { fontStyle: "normal", fontSize: 14, color: '#CCCCCC', marginTop: 20,textAlign:'center' },
