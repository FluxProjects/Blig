            ...
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/regbackground.png')} style={styles.imagebackground}>
                    ...
                    <View style={styles.mainview}>
                        ...
                        <Text style={{ color: 'white' }}> Cub Range   £(1 - {test(3400000)})</Text>
                        <Text style={{ color: 'white' }}> Lion Range £(34 - {test(6700000)})</Text>
                        <Text style={{ color: 'white' }}> Roar Range £(67 - {test(10000000)})</Text>
