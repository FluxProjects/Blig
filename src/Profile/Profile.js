...
export default class Profile extends Component {
    ...
    Entrepreneur_TypeServices = async (v) => {
        ...
        await fetch(this.state.url + '/Entrepreneur/Entrepreneur_Company_Types', {
            ...
            .then(res => res.json())
            .then(resjson => {
                console.log("Entrepreneur business kind===============>", resjson)
                if (resjson.Successful) {
                ...
                <Content>
                                    ...
                                    this.state.EServices.map((data, index) => (
                                        index <= 2 ?
                                            <View style={{ flexDirection: 'row' }}>
                                                <Text key={index} allowFontScaling={false} style={styles.text22}>{this.state.Services[data.business_type-1]}, </Text>
                                            </View>
                                            :
                                            <View>
                                            </View>
                    ...
                    <View style={styles.v10}>
                        ...
                        <View style={styles.v12}>
                            ...
                            <Input editable={this.state.edit} onChangeText={(value) => this.EditEmail(value)} value={this.state.userdata[0].email} underlineColorAndroid="transparent" placeholderTextColor={'white'} style={{ width: '100%',fontSize:14, color: 'white', marginLeft: -6 }}></Input>
                        </View>
                    </View>
                    <View style={styles.v10}>
                        <View style={styles.v11}>
...
const styles = StyleSheet.create({
    ...
    v4: { width: '100%', height: 90, flexDirection: "column", alignItems: "center", justifyContent: 'center' },
    v5: { flexDirection: "row", justifyContent: "space-between", backgroundColor: '#110717', alignSelf:'center' },
