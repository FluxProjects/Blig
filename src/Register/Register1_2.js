...
export default class Register1 extends Component {
    ...
    gotoReg2 = (v) => {
        ...
        //     this.refs.toast.show('Select one!', DURATION.LENGTH_LONG);
        // } else {
        //    // this.props.Screenno(2)
        //    if(key==1){
        //  Actions.onboarding_ent({user:'Founder'})
        //    }
        //    else{
        //     Actions.onboarding_inv({user:'Investor'})
        // }

        // }
        if(this.state.Entrepreneur==1){
         Actions.onboarding_ent({user_id:this.props.user_id})

        }
        else{
         Actions.onboarding_inv({user_id:this.props.user_id})
            ...
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/regbackground.png')} style={styles.imagebackground}>
                    ...
                    <View style={styles.mainview}>
                        <Text allowFontScaling={false} style={{ fontSize: 16, color: '#CCCCCC', marginTop: 10 }}>Are you a Founder Incubator or Accelator?</Text>
                        <View style={styles.v11}>
                            <View style={styles.v2}>
                                ...
                                <Text allowFontScaling={false} style={styles.text}>Founder Incubator</Text>
                            </View>
                            <View style={styles.v2}>
                                ...
                                <Text allowFontScaling={false} style={styles.text}>Founder Accelator</Text>
                            </View>
