...
export default class IRegister4 extends Component {
    ...
    gotoReg5 = () => {
     ...
     else if (this.state.idproof=='') {
            console.log('in id proof')
            this.setState({
                borderColor1:'red'
            })
            this.refs.toast.show('Fill the required Fields', DURATION.LENGTH_LONG);
        }
       else if (this.state.addressproof=='') {
            console.log('in add proof')
            this.setState({
                borderColor:'red'
            })
            this.refs.toast.show('Fill the required Fields', DURATION.LENGTH_LONG);
            ...
            .then(response => {
                ...
                if (response.Successful) {
                    if (v == 1) {
                        ...
                        this.setState({ photo: null, idproof: response.uri,borderColor1:'#ec9705' });
                    } else {
                        this.setState({ progressaddress: 100 })
                        this.setState({ photo: null, addressproof: response.uri,borderColor:'#ec9705' });
                    }
                } else {
                    alert("Upload Failed!");
                }
            ...
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/breg5.png')} style={styles.imagebackground}>
                    ...
                    <View style={styles.mainview2}>
                        <ScrollView>
                            <Item style={[styles.itemstyle,{borderBottomColor:this.state.btmbrdrColor}]} floatingLabel>
                            ...
                            <View style={[styles.v33,{borderColor:this.state.borderColor1}]}>
                            ...
                            <View style={[styles.v33,{borderColor:this.state.borderColor}]}>
                    ...
                    <Modal isVisible={this.state.isModalVisible} backdropOpacity={0} style={styles.r4modal}>
                        <View style={styles.modalv1}>
                            ...
                            <Button onPress={() => { this.data(), this.toggleModal() }} style={styles.modalbtn}>
                                <Text onPress={() => { this.data(), this.toggleModal() }} allowFontScaling={false} style={styles.text1}>Select Location</Text>
                            </Button>
                        </View>
                    </Modal>
                    <Toast
