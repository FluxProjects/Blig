                ...
                <ImageBackground resizeMode="stretch" source={require('../images/breg5.png')} style={styles.imagebackground}>
                    ...
                    <View style={styles.mainviewE3}>
                        ...
                        <Slider
                            ...
                            //     {
                            //         if (value > 0) {
                            //             this.setState({ kindoffunding: Math.ceil(value) + 250000 > 10000000 ? 10000000 : Math.ceil(value) + 250000 })
                            //         }else{
                            //             this.setState({ kindoffunding:0})
                            //         }
                            //     }
                            // }
                                this.setState({ kindoffunding: Math.ceil(value ) })}
                        />
                        <Text allowFontScaling={false} style={styles.text1ER6}>£{test(this.state.kindoffunding)}</Text>
