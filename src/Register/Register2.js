...
export default class IRegister2 extends Component {
    ...
    selectedbox = (key) => {
        switch (key) {
            case 1:
                this.setState({ Ccolor: this.state.selected, Lcolor: 'black', Rcolor: 'black',cubRange:true,lionRange:false,roarRange:false });
                this.props.senddata(2, { kind: 'Cub', kindno: 1 });
                break;
            case 2:
                this.setState({ Lcolor: this.state.selected, Ccolor: 'black', Rcolor: 'black',cubRange:false,lionRange:true,roarRange:false});
                this.props.senddata(2, { kind: 'Lion', kindno: 2 });
                break;
            case 3:
                this.setState({ Rcolor: this.state.selected, Ccolor: 'black', Lcolor: 'black',roarRange:true,cubRange:false,lionRange:false       });
                    ...
                    <View style={styles.mainview}>
                        ...
                        <View style={styles.v11}>
                            <View style={styles.v2}>
                                <TouchableWithoutFeedback onPress={() => [this.selectedbox(1),this.onDoublePress('v')]}>
                            ...
                            <View style={styles.v2}>
                                <TouchableWithoutFeedback onPress={() => [this.selectedbox(2),this.onDoublePress('v')]}>
                            ...
                            <View style={styles.v2}>
                                <TouchableWithoutFeedback onPress={() => [this.selectedbox(3),this.onDoublePress('v')]}>
...
{ this.state.cubRange==true ? <Text style={{ color: 'white' }}> CUB RANGE  (£1 - {test(3400000)})</Text> : <Text></Text>}
{ this.state.lionRange==true ? <Text style={{ color: 'white' }}> LION RANGE  (£34 - {test(6700000)})</Text> : <Text></Text>}
                        
{ this.state.roarRange==true ? <Text style={{ color: 'white' }}> ROAR RANGE  (£67 - {test(10000000)})</Text> : <Text></Text>}
