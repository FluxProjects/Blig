            ...
            <View style={styles.container}>
                ...
                <ImageBackground resizeMode="stretch" source={require('../images/regbackground.png')} style={styles.imagebackground}>
                    ...
                    <View style={styles.mainview}>
                        <Text allowFontScaling={false} style={{ fontSize: 16, color: '#CCCCCC', marginTop: 10 }}>Are you a Founder or Investor?</Text>
                        <View style={styles.v11}>
                            <View style={styles.v2}>
                                ...
                                <Text allowFontScaling={false} style={[styles.text,]}>Founder</Text>
                            </View>
                            <View style={styles.v2}>
