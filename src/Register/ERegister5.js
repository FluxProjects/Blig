...
export default class ERegister5 extends Component {
  ...
  else  if (this.state.cityname=='City'|| this.state.statename == 'State' || this.state.Cname == '' )
    {
      console.log('4th if')
      ...
      <View style={styles.container}>
        ...
        <ImageBackground resizeMode="stretch" source={require('../images/breg5.png')} style={styles.imagebackground}>
          ...
          <View style={styles.mainview2}>
            <ScrollView>
              <Item style={[styles.itemstyle, !this.state.ComRegIdValidate ? styles.error : null,{borderBottomColor:this.state.idcolor}]} floatingLabel>
              ...
              <Item style={[styles.itemstyle, !this.state.ComNameValidate ? styles.error : null,{borderBottomColor:this.state.CnameColor}]} floatingLabel>
              ...
              <Textarea value={this.state.Description} allowFontScaling={false} rowSpan={5} onChangeText={(v) => this.Validation(v, 'Description')} placeholder="Company Description" placeholderTextColor="#878787" style={[styles.v33, { color: 'white', height: 180 }, !this.state.DescriptionValidate ? styles.textareaError : null,{borderColor:this.state.descColor}]} />
              <View style={[styles.v33, { height: 150 ,borderColor:this.state.locationColor}]}>
          ...
          <Modal isVisible={this.state.isModalVisible} backdropOpacity={0} style={styles.r4modal}>
            <View style={styles.modalv1}>
              ...
              <Button onPress={() => { this.data(), this.toggleModal() }} style={styles.modalbtn}>
                <Text onPress={() => { this.data(), this.toggleModal() }} allowFontScaling={false} style={{ color: 'white' }}>Select Location</Text>
              </Button>
            </View>
          </Modal>
