...
import select from './Register/Register1';
...
import onboarding_ent from './Onboarding/onboarding';
import onboarding_inv from './Onboarding/investor_onboarding';
import WACC1 from './WACC_Calculator/WACC1';
import WACC2 from './WACC_Calculator/WACC2';
        ...
        if (resjson.Successful) {
          if (this.state.Type == true) {
            if (resjson.entrepreneur.length == 0) {
              ...
              (resjson.investor[0].active == null) &
              (resjson.entrepreneur[0].active == null)
            ) {
  ...
  render() {
    ...
    return this.state.loading ? (
      <View style={styles.container}>
        ...
        <ImageBackground
          resizeMode="stretch"
          source={require('./images/breg9.png')}
      ...
      <Router onStateChange={v => console.log('v')}>
        <Stack key="root" headerLayoutPreset="center">
          ...
          <Scene
            header={null}
            key="onboarding_ent"
            component={onboarding_ent}
          />
          <Scene
            header={null}
            key="review"
            component={review}
            initial={this.state.review}
          />

          <Scene
            header={null}
            key="onboarding_inv"
            component={onboarding_inv}
          />
          <Scene
            header={null}
            key="Welcome2"
          ...
          />
          <Scene header={null} key="Kinds" component={Kinds} initial={false} />
          <Scene
            header={null}
            key="SubPlan"
            component={SubPlan}
          ...
          />
          <Scene key="WACC1" component={WACC1} hideNavBar={true} duration={0} />
          <Scene
            header={null}
            key="WACC2"
            component={WACC2}
...
export default connect(
  mapStateToProps,
  {counterincrement, counterdecrement, counterset},
)(Navigation);
