            ...
            <Container style={{ backgroundColor: '#110717' }}>
                ...
                <Content padder>
                    ...
                    <Item style={{ marginTop: 10 }} floatingLabel>
                        ...
                        <Input keyboardType="number-pad" allowFontScaling={false} onChangeText={(value, ) => this.Validation(value, 2)} value={this.state.cardNo} style={styles.input} />
                       {
                           this.state.cardNof?
                    ...
                    <View style={styles.v22}>
                        <DatePicker
                            ...
                            disabled={false}
                        />
                        <Icon name="calendar" style={{ color: '#EC9705',marginRight:7 }} type="AntDesign" />
