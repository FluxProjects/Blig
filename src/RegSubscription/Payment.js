...
import Pic from '../images/creditCard.png'
...
export default class Payment extends Component {
    ...
    UserSubscription = async () => { //copied from Reg fragment for subscription
        ...
        this.setState({ loading: true })
        if (this.state.Namef == true & this.state.cvcf == true & this.state.datef == true & this.state.cardNof == true & this.props.Amount > 0) {
            let userid = null
            let Ent = false
            ...
            this.setState({ loading: false })
            console.log("t=>", this.state.validity, this.props.Amount)
            this.refs.toast.show('Fill the Required Fieldss!', DURATION.LENGTH_LONG);
        }
    }
    render() {
        return (
            <Container style={{ backgroundColor: '#110717' }}>
                ...
                <Content padder>
                    ...
                    <Image source={Pic} resizeMode="stretch" style={{ width: '90%', alignSelf: 'center', height: 200 }} />
                    ...
                    <Item style={{ marginTop: 10 }} floatingLabel>
                        ...
                        {
                            this.state.cardNof ?
                                <Icon name="check" style={{ color: 'green' }} type="EvilIcons" />
                                : null
                        }
                    </Item>
